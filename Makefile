...
game.out: game.o system.o tinygl.o display.o ledmat.o pio.o font.o pacer.o timer.o paddle.o navswitch.o ball.o ir_uart.o usart1.o timer0.o prescale.o setup.o
	$(CC) $(CFLAGS) $^ -o $@ -lm
	$(SIZE) $@
